                            ...
                            <div className="flex items-start gap-6 bg-white p-6  rounded-xl">
                                ...
                                <div>
                                    ...
                                    <ul className="space-y-2 text-sm text-grey-dark">
                                        <li>✓ Athugar kerfið hvort dagsetningar eru lausar</li>
                                        <li>✓ Athugar sanngirnisreglu (ef hún er virk)</li>
                                        <li>✓ Vistar bókun í rauntíma</li>
                                        <li>✓ Sendir tilkynningar á alla eigendur (email + push)</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
